import { SyntaxKind, VariableDeclaration, NewExpression, ClassDeclaration, FunctionDeclaration, MethodDeclaration, ParameterDeclaration, Node, Expression } from "ts-morph";
import { FUNCTION_KINDS } from "../utils/typeDefined";
import { fixType, getFileName } from "../utils/tool";
